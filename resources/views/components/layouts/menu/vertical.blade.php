...
<aside id="fbs__net-navbars" class="layout-menu menu-vertical menu bg-menu-theme offcanvas-xl offcanvas-start">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item {{ request()->routeIs('admin.contact-messages.index') ? 'active' : '' }}">
        <a class="menu-link" href="{{ route('admin.contact-messages.index') }}" wire:navigate>
            <i class="menu-icon tf-icons bx bx-envelope"></i>
            <div class="text-truncate">Messages</div>
        </a>
    </li>
    <li class="menu-item {{ request()->routeIs('admin.abouts.*') ? 'active' : '' }}">
        <a class="menu-link" href="{{ route('admin.abouts.index') }}" wire:navigate>
            <i class="menu-icon tf-icons bx bx-info-circle"></i>
            <div class="text-truncate">À Propos</div>
        </a>
    </li>
    <li class="menu-item {{ request()->routeIs('admin.settings.*') ? 'active' : '' }}">
        <a class="menu-link" href="{{ route('admin.settings.index') }}" wire:navigate>
