            ...
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        <td>
                            @if($partner->logo)
                                <img src="{{ asset('uploads/' . $partner->logo) }}" alt="Logo" class="d-block rounded" height="50" width="auto">
                            @else
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('admin.partners.edit', $partner) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
